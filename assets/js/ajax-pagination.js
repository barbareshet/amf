...
jQuery(document).ready(function($){
    ...
    var page = 1;
    $('a.btn-loadmore').on('click', function( event ){
        event.preventDefault();
        console.log('clicked');
        ...
        $.ajax({
            ...
            success: function( html ) {
                ...
                if(html == ''){
                    $('a.btn-loadmore').hide();
                    $('.all-posts').after( '<div class="no-more-posts" style="text-align:center;">No More Events to Show</div>' );
                }
            }
        })
    });
